...
#    And I get the id of label "bug" in repository "ahmedghamad/Graphql-Label-Testing"
...
#    Then the API should return an error message
  ...
  Scenario: Delete a label with an invalid token should fail
    ...
    And I have a valid label id for deletion in the repository "ahmedghamad/Graphql-Label-Testing"
    When I send a deleteLabel mutation
